...
public final class PitToolWindowFactory implements ToolWindowFactory, DumbAware {
  ...
  private static void addAll(PitExecutionRecorder recorder) {
    recorder.visit(new PitExecutionRecorder.FileVisitor() {
      ...
      public void visit(String filePath, FileMutations fileMutations) {
        ...
        System.out.println("Adding: " + filePath + " " + score);
        mutationControlPanel.setLine(filePath, score);
      }
    });
  }
  ...
  public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
    ...
    //JPanel myPanel = createLine("blue",33);
    ...
    /* Last one working on
    MutationResultsContent myToolWindow = new MutationResultsContent();
    ContentFactory contentFactory = ContentFactory.getInstance();
  ...
  private static class MutationResultsContent {
